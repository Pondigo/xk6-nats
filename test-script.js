...
export default function () {
    ...
    try {
        ...
        if (streamInfo) {
            console.log('Stream info:', streamInfo.config.name, 'Messages:', streamInfo.state.messages);
        }
    } catch (error) {
    ...
    try {
        ...
        if (consumerInfo) {
            console.log('Consumer info:', consumerInfo.config.durable, 'Delivered:', consumerInfo.delivered);
        }
    } catch (error) {
